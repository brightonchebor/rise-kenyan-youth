                    ...
                    <div className="lg:grid lg:grid-cols-12 lg:gap-16 items-start">
                        ...
                        <div className="lg:col-span-6">
                            ...
                            <div className="mt-10 flex flex-col sm:flex-row gap-4">
                                <button className="group bg-gitblue-600  hover:from-blue-700 hover:to-purple-700 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center">
                                    View Programs
